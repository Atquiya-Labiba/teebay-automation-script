...
class EditProdPage:
    #Page header
    page_header=(By.CSS_SELECTOR,".ui.header")
    #Edit button Locators
    edit_product_btn = (By.XPATH, "//button[text()='Edit Product']")
    ...
    def click_edit(self):        
            self.wait.until(EC.element_to_be_clickable(self.edit_product_btn)).click()
